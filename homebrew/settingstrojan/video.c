...
void video_display_on_vblank()
{
    ...
    videobase[POWERVR2_FB_DISPLAY_ADDR_2] = global_buffer_offset[buffer_loc] + (global_video_width * 2);
...
void video_init_simple()
{
    ...
    global_buffer_offset[1] = global_buffer_offset[0] + (global_video_width * global_video_height * 2);
    global_buffer_offset[2] = global_buffer_offset[1] + (global_video_width * global_video_height * 2);
    ...
    memset(zero_base, 0, global_video_width * global_video_height * 2 * 2);
    ...
    videobase[POWERVR2_FB_RENDER_MODULO] = (2 * global_video_width) / 8;
    ...
    videobase[POWERVR2_FB_DISPLAY_SIZE] = (
        ...
        (((global_video_width / 4) * 2) - 1) << 0  // ((width / 4) * bpp) - 1
    );
